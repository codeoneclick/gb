...
#endif
bool ws_technique_configuration::get_draw_bounding_boxes(void) const
{
...
#if defined(__EDITOR__)
void ws_technique_configuration::set_draw_bounding_boxes(bool are_draw_bounding_boxes)
{
