...
#endif
#if defined(__EDITOR__)
void set_ws_technique_configuration(const std::shared_ptr<gbws_technique_configuration>& ws_technique, i32 index);
#endif
...
#endif
#if defined(__EDITOR__)
void set_ss_technique_configuration(const std::shared_ptr<gbss_technique_configuration>& ss_technique, i32 index);
#endif
