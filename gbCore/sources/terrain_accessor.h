...
#ifndef terrain_accessor_h
#define terrain_accessor_h
...
namespace gb
{
    ...
    private:
        ...
        std::shared_ptr<terrain_container> m_container;
        bool m_isGenerated;
        graphics_context_shared_ptr m_graphics_context;
        
        std::array<std::queue<texture_shared_ptr>, terrain_container::e_heigtmap_chunk_lod_max> m_splatting_diffuse_textures_cache;
        std::array<std::queue<texture_shared_ptr>, terrain_container::e_heigtmap_chunk_lod_max> m_splatting_normal_textures_cache;
        std::array<std::queue<texture_shared_ptr>, terrain_container::e_heigtmap_chunk_lod_max> m_splatting_displace_textures_cache;
        ...
        std::vector<std::tuple<mesh_shared_ptr, texture_shared_ptr, texture_shared_ptr, terrain_container::e_heigtmap_chunk_lod, std::shared_ptr<std::mutex>>> m_chunks_data;
        std::vector<std::tuple<glm::vec3, glm::vec3>> m_chunks_bounds;
        
        std::array<texture_shared_ptr, terrain_texture_generator::e_splatting_texture_max> m_diffuse_textures;
        std::array<texture_shared_ptr, terrain_texture_generator::e_splatting_texture_max> m_normal_textures;
        std::array<texture_shared_ptr, terrain_texture_generator::e_splatting_texture_max> m_displace_textures;
        
        std::queue<thread_operation_shared_ptr> m_update_terrain_operations;
        ...
        void generate_mesh(i32 index, terrain_container::e_heigtmap_chunk_lod lod);
        void generate_splatting_textures(i32 index, terrain_container::e_heigtmap_chunk_lod lod);
    ...
    public:
        ...
        static f32 get_height(const terrain_container_shared_ptr& container, const glm::vec3& position);
        static glm::vec3 get_normal(const terrain_container_shared_ptr& container, const glm::vec3& position);
        static glm::vec2 get_angles_xz(const terrain_container_shared_ptr& container, const glm::vec3& position);
