...
namespace gb
{
    ...
    void heightmap_chunk::set_normal_displace_texture(const texture_shared_ptr& texture)
    {
    ...
    {
        unsafe_get_render_component_from_this->set_bind_material_imposer_callback(std::bind(&heightmap_chunk::on_bind_material_imposer_callback,
