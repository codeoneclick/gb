...
#define k_max_contains_in_vbo 4
    ...
    public:
        ...
        public:
            ...
            terrain_memory_map(const std::shared_ptr<memory_map>& descriptor) :
            ...
            virtual ~terrain_memory_map() = default;
        ...
        class terrain_vbo_memory_map : public terrain_memory_map
        {
        private:
        ...
        public:
            ...
            terrain_vbo_memory_map(const std::shared_ptr<memory_map>& descriptor) : terrain_memory_map(descriptor) { };
            ~terrain_vbo_memory_map() = default;
        ...
        class terrain_ibo_memory_map : public terrain_memory_map
        {
        private:
        ...
        public:
            ...
            terrain_ibo_memory_map(const std::shared_ptr<memory_map>& descriptor) : terrain_memory_map(descriptor) { };
            ~terrain_ibo_memory_map() = default;
            ...
            {
                ui16* source_pointer = terrain_ibo_memory_map::get_source_pointer();
                ui16* origin_pointer = terrain_ibo_memory_map::get_origin_pointer();
                memcpy(source_pointer, origin_pointer, m_size * sizeof(ui16));
            };
        };
        
        class terrain_texture_memory_map_RGB565 : public terrain_memory_map
        {
        private:
        ...
        public:
            ...
            terrain_texture_memory_map_RGB565(const std::shared_ptr<memory_map>& descriptor) : terrain_memory_map(descriptor) { };
            ~terrain_texture_memory_map_RGB565() = default;
        ...
        class terrain_texture_memory_map_RGBA8 : public terrain_memory_map
        {
        private:
        ...
        public:
            ...
            terrain_texture_memory_map_RGBA8(const std::shared_ptr<memory_map>& descriptor) : terrain_memory_map(descriptor) { };
            ~terrain_texture_memory_map_RGBA8() = default;
    ...
    private:
        ...
        std::vector<std::array<std::shared_ptr<terrain_texture_memory_map_RGBA8>, e_heigtmap_chunk_lod_max>> m_splatting_normal_textures_mmap;
        std::vector<std::array<std::shared_ptr<terrain_texture_memory_map_RGBA8>, e_heigtmap_chunk_lod_max>> m_splatting_displace_textures_mmap;
