...
namespace gb
{
    ...
    private:
        ...
        static void create_splatting_rgb565_mask(const terrain_container_shared_ptr& container, const std::string& filename);
        ...
        static void create_splatting_texture(const graphics_context_shared_ptr& graphics_context,
                                             ...
                                             ui32 offset_x, ui32 offset_y, const std::function<void(ui8 *, ui32, terrain_container::e_heigtmap_chunk_lod lod)>& callback);
    ...
    public:
        ...
        terrain_texture_generator() = default;
        ~terrain_texture_generator() = default;
        
        static void splatting_masks(const terrain_container_shared_ptr& container, const std::string& filename);
        static void splatting_mask(const terrain_container_shared_ptr& container,
        ...
        static void generate_deep_texture(const terrain_container_shared_ptr& container, bool create,
