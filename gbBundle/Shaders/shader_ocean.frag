...
void main()
{
    ...
    float deep = k_1 - texture2D(sampler_04, v_texcoord).r;
    deep = clamp((deep - k_05) * deep_contast + k_05, k_0, k_1);
    ...
    vec4 color = mix(refraction_color, reflection_color, fresnel * deep);
